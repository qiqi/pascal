#include "stage.h"   // SUBSTITUTE
#include "hooks.h"

inline void stages(uint64_t i0, uint64_t i1, uint64_t j0, uint64_t j1, float * p_workspace, hook_func_t p_send, hook_func_t p_recv) { STAGE_NAME(i0, i1, j0, j1, p_workspace, p_send, p_recv); }  // SUBSTITUTE
